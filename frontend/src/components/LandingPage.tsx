    ...
    >
      <Container maxWidth="sm">
        <Card sx={{ p: 4, textAlign: 'center', boxShadow: 3, borderRadius: 4 }}>
          <Typography variant="h3" gutterBottom sx={{ fontFamily: 'Inter, Roboto, Arial, sans-serif', fontWeight: 800 }}>
            Trading Platform
          </Typography>
          <Typography variant="body1" color="text.secondary" gutterBottom sx={{ fontSize: '1.2rem' }}>
